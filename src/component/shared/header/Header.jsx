...
<div className={`${drop ? 'block lg:flex absolute lg:static z-20  top-[85px] shadow-lg space-y-3 py-3': 'hidden lg:flex'} gap-10  w-full  lg:w-auto items-center text-[1.1rem]`}>
  <div>
    <a className="hover:opacity-50" href="/">Home</a>
